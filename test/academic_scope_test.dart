...
/// et un physicien de voir l'ICT4D : rien n'est codé en dur, tout vient du
/// document `users` du compte.
void main() {
  UniFlowUser compte(String role, {String? program = 'ICT4D', String? level = 'L2', String type = 'UNIVERSITY', String? university = 'Université de Yaoundé I'}) =>
      UniFlowUser(id: 'u', email: 'u@t.cm', name: 'U', accountType: type, role: role, university: university, program: program, level: level);
  ...
  AcademicDirectoryEntry membre(String role, String program, String level) =>
      AcademicDirectoryEntry(id: role + program + level, userId: role, name: role, role: role, university: 'Université de Yaoundé I', program: program, level: level);
  ...
  test('emploi du temps et bibliothèque suivent le cours, par identifiant ou par code', () {
    final scope = AcademicScope.forUser(compte('STUDENT'));
    final slots = [
      AcademicSchedule(id: 'a', courseId: 'INF211', courseCode: '', dayOfWeek: 'LUNDI', startTime: '08:00', endTime: '10:00', classroom: ''),
      AcademicSchedule(id: 'b', courseId: 'autre', courseCode: 'inf211', dayOfWeek: 'MARDI', startTime: '08:00', endTime: '10:00', classroom: ''),
      AcademicSchedule(id: 'c', courseId: 'INF111', courseCode: 'INF111', dayOfWeek: 'MARDI', startTime: '08:00', endTime: '10:00', classroom: ''),
    ];
    final kept = scope.byCourse(slots, scope.courses([cours1, cours2]), (s) => s.courseId, courseCodeOf: (s) => s.courseCode);
